...
alias sa="defaults write com.apple.finder AppleShowAllFiles TRUE;killall Finder"
alias ha="defaults write com.apple.Finder AppleShowAllFiles FALSE;killall Finder"
